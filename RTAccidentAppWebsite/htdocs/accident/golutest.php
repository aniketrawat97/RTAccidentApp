...
echo "<table>"."<tr>"."<th>"."Accident Title"."</th>"."<th>"."State"."</th>"."<th>"."City"."</th>"."<th>"."Localty"."</th>"."<th>"."Insurance_company"."</th>"."<th>"."Description"."</th>"."</tr>";

if (mysqli_num_rows($result) > 0) {
    // output data of each row
    while($row = mysqli_fetch_assoc($result)) {
      echo "<tr>"."<td>".$row["Title"]."</td>"."<td>".$row["State"]."</td>"."<td>".$row["City"]."</td>"."<td>".$row["Locality"]."</td>"."<td>".$row["Insurance_company"]."</td>"."<td>"."<button id='descrp' onclick='document.getElementById('pop').style.display='block''>"."View"."</button>"."</td>"."</tr>";
		>?
		<button id="descrp" onclick="document.getElementById("\"pop\"").style.display = "\"block\"" ">View</button>';
		echo '<div id="pop">';
