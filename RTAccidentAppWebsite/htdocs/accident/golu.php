...
echo "<table>"."<tr>"."<th>"."Accident Title"."</th>"."<th>"."State"."</th>"."<th>"."City"."</th>"."<th>"."Localty"."</th>"."<th>"."Ins_comp"."</th>"."<th>"."Description"."</th>"."</tr>";

if (mysqli_num_rows($result) > 0) {
    // output data of each row
    while($row = mysqli_fetch_assoc($result)) {
		$x=$row["Case_ID"];
        echo "<tr>"."<td>".$row["Title"]."</td>"."<td>".$row["State"]."</td>"."<td>".$row["City"]."</td>"."<td>".$row["Locality"]."</td>"."<td>".$row["Insurance_company"]."</td>"."<td>"."<a href='report.php?Case_ID=$x' target='_blank' ><button id='descrp' type='submit' method='get'>View</button></a>"."</td>"."</tr>";
	}
} else {
    echo "0 results";
}
